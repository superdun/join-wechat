...
<section class="kaib-e-bg">
    ...
    <div class="kaib-e">
        ...
        <div class="bd hide">
            ...
            <div class="info">
                卓因青少年创意工场是专注于将科技与青少年教育融合的专业机构。课程以科学制作、创意设计、生活实践等多元课程为主要载体，针对3-18岁儿童及青少年开展机器人&STEAM专项教育培训。致力于“体验式学习”理念，以Project-based learning的学习方式，让学员在过程中学习科学、物理、化学、逻辑－数学、计算机图形化编程等学科知识，培养孩子热爱科学、乐于动手实践的精神，发扬创客精神，开拓勇于创新的思维，建立积极的学习习惯并享受学习的乐趣。课程形式包括机器人成长课程、创客课程、机器人竞赛课程以及亲子科技课程。
            </div>
        </div>
