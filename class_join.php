...
<section class="kaib-a">
    ...
    <div class="bd">
        <form>
            <ul class="kaib-ul-01">
                <input type="hidden" name="data[classId]" value="<?=$id?>">
                <li class="clearfix">
                ...
                <li class="clearfix">
                    ...
                    <div class="checkbox clearfix">
                        <div class="chk-nan">
                            <input id="radio_1" name="data[sex]" value="男孩" class="radio_1" type="radio" checked>
                            <label for="radio_1"></label>
                            男孩
                        </div>
                        <div class="chk-nv">
                            <input id="radio_2" name="data[sex]" value="女孩" class="radio_1" type="radio">
        ...
        <script>
            $('script:last').prev().submit(function(){
                ...
                $.ajax({
                    ...
                    data:{
                        'action' : 'message',
                        'redirectURL' : "<?=PATH?>class_ok.php",
                        'data[classId]' : _this.find("[name='data[classId]']").val(),
