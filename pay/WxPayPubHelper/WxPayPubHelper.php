...
class JsApi_pub extends Common_util_pub
{
    ...
    var $access_token;//用户的access_token
    var $userInfo;//用户基本信息
    ...
    function getOpenid()
    {
        ...
        //exit($data['access_token']);
        //$this->access_token = $data['access_token'];
        return $this->openid;
    }

    /**
     * 	作用：通过curl向微信提交code，以获取access_token
     */
    ...
    /**
     * 	作用：通过curl向微信提交code，以获取用户基本信息
     */
    function getUserInfo()
    {
        //先执行获取openid和access_token的方法
        $this->getOpenid();
        $this->getAccessToken();
    ...
    function getSubscribe($access_token, $openid)
    {
